...
namespace program
{
    ...
    {
        private static readonly object myJsonResponse;
        private static object JsonConvert;
        private Root myDeserializedClass = JsonConvert.DeserializeObjectRoot(myJsonResponse);
        public class Ara
        {
        ...
        {
            public Listdouble latlng { get; set; }
        }

        public class Car
        {
            public Liststring signs { get; set; }
        ...
        public class Idd
        {
            ...
            public Liststring suffixes { get; set; }
        }
        ...
        public class Root
        {
            ...
            public Liststring capital { get; set; }
            public Liststring altSpellings { get; set; }
            public string region { get; set; }
            public string subregion { get; set; }
            public Languages languages { get; set; }
            public Translations translations { get; set; }
            public Listint latlng { get; set; }
            public bool landlocked { get; set; }
            public Liststring borders { get; set; }
            ...
            public Liststring timezones { get; set; }
            public Liststring continents { get; set; }
